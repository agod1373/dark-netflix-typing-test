...
def the_gui():
    ...
    layout = [[sg.Text('Click start test to reveal quote')],
              ...
              [sg.Text(key='raw', font=15, size=(80, 10))],
    ...
    while True:
        ...
        if event == 'Start Test':
            ...
            window['raw'].update('Length of sample: {}s\nNumber of correct words: {}\nNumber of incorrect words: {}\nIncorrect words: {}\nRaw WPM: {}\nNet WPM: {}'.format(rounded_time, correct_ct, incorrect_ct, incorrect_l, raw_wp, net_wp))
    window.close()
